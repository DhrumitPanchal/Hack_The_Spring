...
function Footer() {
  return (
    <footer class="bg-slate-200 text-black">
      <div class="mx-auto w-full max-sm:px-[1.6rem]  p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between max-sm:gap-[4rem]">
          <div class="pl-[2rem] max-sm:pl-0 mb-6 md:mb-0">
          ...
          <div className="max-sm:mt-[2rem] flex flex-col">
            <h2 className="text-[1.3rem] font-semibold mb-[.4rem]">
              Quick links
            </h2>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
          ...
          <div class="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
            <a
              href="#"
              class="text-gray-500  hover:text-primaryColor transition-all duration-300"
            >
              <svg
                class="w-6 h-6"
                aria-hidden="true"
